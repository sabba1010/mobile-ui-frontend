    ...
    try {
      ...
      const res = await fetch(`${API_URL}/api/user/withdraw`, {
        ...
        body: JSON.stringify({ 
          ...
          walletDetails: `${activeWallet.type === 'bank' ? 'Bank Account' : 'Mobile Money'} - ${activeWallet.bankName ? activeWallet.bankName + ' - ' : ''}${activeWallet.label} (Acct: ${activeWallet.number})`
        })
      });
